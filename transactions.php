...
<body>
    <div class="container">
        ...
        <div class="navigation">
            <a href="#" id="addTransactionLink">Add Transaction</a>
        </div>
                    ...
                    <tbod>
                        ...
                        <?php foreach ($transactions as $transaction): ?>
                            <tr>
                                ...
                                <!-- <td><?php echo htmlspecialchars($transaction['linked_item']); ?></td> -->
                                <td class="actions">
                                    <a href="edit_transactions.php?id=<?php echo htmlspecialchars($transaction['id']); ?>"
                                        class="edit">Edit</a>
                                    <a href="delete_transaction.php?id=<?php echo htmlspecialchars($transaction['id']); ?>"
                                        class="delete"
    ...
    <script>
        $(document).ready(function () {
            $('#addTransactionLink').click(function (e) {
                e.preventDefault();
